...
<center>
    <form name="frm" method="post" action="<%= request.getContextPath() %>/TeacherInsert">
        <table border=1>
            <tr class="td_header"><td colspan="2"> 教师信息录入，<span class="star">*</span>为必填项</td></tr>
            <tr><td>编号</td><td><input type="text" name="code" value="" size="20"  placeholder="5位字符数字" required pattern="[0-9]{5}"><span class="star">*</span></td></tr>
